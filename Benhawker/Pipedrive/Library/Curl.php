<?php
namespace MauticPlugin\PipedriveBundle\Benhawker\Pipedrive\Library;

use MauticPlugin\PipedriveBundle\Benhawker\Pipedrive\Exceptions\PipedriveHttpError;
use MauticPlugin\PipedriveBundle\Benhawker\Pipedrive\Exceptions\PipedriveApiError;
...
class Curl
{
    ...
    protected function exec()
    {
        ...
        if (floor($info['http_code'] / 100) >= 4) {
            //throw error
            throw new PipedriveApiError('API HTTP Error ' . $info['http_code'] . '. Message ' . print_r($result,TRUE));
        }
        // return output
        return $result;
    }
